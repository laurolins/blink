/* Generated By:JavaCC: Do not edit this line. CommandLineInterfaceParserTokenManager.java */
package blink.cli;

public class CommandLineInterfaceParserTokenManager implements CommandLineInterfaceParserConstants
{
...
null, null, null, null, null, null, null, null, "\72", "\50", "\51", "\75", null, 
null, null, "\54", "\133", "\135", "\173", "\175", };
...
public CommandLineInterfaceParserTokenManager(JavaCharStream stream){
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public CommandLineInterfaceParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
