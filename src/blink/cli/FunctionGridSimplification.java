 ...
 * @version 1.0
 */
public class FunctionGridSimplification extends Function {
    public FunctionGridSimplification() {
        super("gredysimplification","Simplificar gema");
    }
    ...
    public Object hardwork(ArrayList params, DataMap localMap) throws EvaluationException, Exception {
        if(params.get(0) instanceof Gem ){
        	...
        	while(true){
        		Gem G3 = G1.copy();
        		G1 = G1.getVersionWithoutFourClusters();
        		if(G3.getNumVertices() == G1.getNumVertices()){
        			break;
        		}
        	}
