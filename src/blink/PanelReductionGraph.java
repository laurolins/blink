 ...
 * @version 1.0
 */
public class PanelReductionGraph extends JPanel {
    Graph _G;
    Lens _lenses;
    ...
    public PanelReductionGraph(Graph G) {
        _G = G;
        this.buildUI();
    }
    ...
    private void buildUI() {
        ...
        pr.setVertexStringer(new PRGVertexLabeler());
        pr.setEdgeStringer(new PRGEdgeLabeler());
        ...
        pr.setEdgeIncludePredicate(new PRGEdgeIncludePredicate());
        pr.setVertexIncludePredicate(new PRGVertexIncludePredicate());
        ...
        // setup viewer
        _view = new VisualizationViewer(new PRGLayout(_G),pr);
...
//    		    System.err.println("Vertex "+v+" was released at ("+me.getX()+","+me.getY()+")");
    ...
    class PRGEdgeIncludePredicate implements Predicate {
        public boolean evaluate(Object o) {
            return true;
        }
    }

    class PRGVertexIncludePredicate implements Predicate {
        public boolean evaluate(Object o) {
            Vertex v = (Vertex) o;
    ...
    class PRGLayout extends AbstractLayout {

        public PRGLayout(Graph g) {
            super(g);
        }
...
class PRGVertexLabeler implements VertexStringer {
...
class PRGEdgeLabeler implements EdgeStringer {
    public String getLabel(ArchetypeEdge e) {
        Object o = e.getUserDatum("key");
        if (o instanceof Move) {
            return ((Move) o).getSignature();
        }
        return "";
        /*
        if (o instanceof TSMovePoint) {
            TSMovePoint tsmp = (TSMovePoint) o;
            String s = ""+tsmp.getType()+" "+GemVertex.getColorSetCompactString(tsmp.getP())+" "+tsmp.getA();
            return s;
        }
        else if (o instanceof Dipole) {
            Dipole d = (Dipole) o;
            String s = "D"+d.size()+" "+
                       GemVertex.getColorSetCompactString(d.getColorSet())+" "+
                       d.getU().getLabel()+" "+d.getV().getLabel();
            return s;
        }
        else if (o instanceof RhoPair) {
            RhoPair d = (RhoPair) o;
            String s = "R"+d.foundAsA()+GemVertex.getColorSetCompactString(d.getColor())+" "+d.getU().getLabel()+" "+d.getV().getLabel();
            return s;
        }*/
    }
}
