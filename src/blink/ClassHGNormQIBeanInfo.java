 ...
 * @version 1.0
 */
public class ClassHGNormQIBeanInfo extends SimpleBeanInfo {
        Class beanClass = ClassHGNormQI.class;
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
                try {
                        ...
                        PropertyDescriptor _qi = new PropertyDescriptor("_qi", beanClass, "getStringOfQIs", null);
