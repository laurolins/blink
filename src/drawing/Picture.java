...
public class Picture extends AbstractDrawing {
	/**
	...
	public Picture(IGroup parent, double x0, double y0, double theta, double width, double height, String fileName ) throws IOException {
	...
	public void draw(Graphics2D G, AffineTransform T) {	
		...
		// draw the shape
		G.drawImage(_image, (int) points[0], (int) points[1], (int) (points[4]-points[0]), (int) (points[5]-points[1]), null);
